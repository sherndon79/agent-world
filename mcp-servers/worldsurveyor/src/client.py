#!/usr/bin/env python3
"""
WorldSurveyor HTTP Client

Handles HTTP communication with the Isaac Sim WorldSurveyor Extension.
"""
...
logger = logging.getLogger("worldsurveyor.client")


class WorldSurveyorClient:
    """HTTP client for WorldSurveyor extension communication."""

    def __init__(self, base_url: str = None):
        self.base_url = base_url or os.getenv("AGENT_WORLDSURVEYOR_BASE_URL", "http://localhost:8891")
...
_client: WorldSurveyorClient = None


def get_client() -> WorldSurveyorClient:
    """Get the global WorldSurveyor client instance."""
    global _client
    if _client is None:
        _client = WorldSurveyorClient()
    return _client
