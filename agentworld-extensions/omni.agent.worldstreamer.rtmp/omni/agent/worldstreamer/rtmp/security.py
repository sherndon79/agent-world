...
class WorldStreamerAuth:
    ...
    def get_auth_requirements(self) -> Dict[str, Any]:
        ...
        bearer_enabled = AUTH_AVAILABLE and is_bearer_auth_enabled('worldstreamer.rtmp')
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'bearer_auth_enabled': AUTH_AVAILABLE and is_bearer_auth_enabled('worldstreamer.rtmp'),
