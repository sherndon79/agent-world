"""HTTP handler bridging WorldStreamer RTMP routes to controller/service stack."""
...
LOGGER = module_logger(service='worldstreamer.rtmp', component='http_handler')


class WorldStreamerHTTPHandler(WorldHTTPHandler):
    """HTTP request handler for WorldStreamer RTMP operations."""
