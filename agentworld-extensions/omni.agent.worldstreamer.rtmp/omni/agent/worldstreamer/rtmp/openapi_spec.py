...
def get_worldstreamer_openapi_spec(port: int = 8905, auth_enabled: bool = True) -> Dict[str, Any]:
    ...
    spec = {
        ...
        "info": {
            ...
            "description": "Isaac Sim RTMP streaming control API for agent-world extensions",
            "version": "1.0.0",
            "contact": {
        ...
        "paths": {
            ...
            "/streaming/start": {
                "post": {
                    ...
                    "description": "Start RTMP streaming session in Isaac Sim",
            ...
            "/streaming/stop": {
                "post": {
                    ...
                    "description": "Stop active RTMP streaming session",
            ...
            "/streaming/status": {
                "get": {
                    ...
                    "description": "Get current RTMP streaming status and information",
            ...
            "/streaming/urls": {
                "get": {
                    ...
                    "description": "Get RTMP streaming client URLs for connection",
            ...
            "/streaming/environment/validate": {
                "get": {
                    ...
                    "description": "Validate Isaac Sim environment for RTMP streaming",
