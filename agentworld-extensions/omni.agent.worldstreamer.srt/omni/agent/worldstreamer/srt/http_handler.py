        ...
        for method, method_routes in self._routes.items():
            ...
            for route in method_routes.keys():
                ...
                if 'health' in route:
                    ...
                    routes[method][route] = 'Start SRT streaming'
                elif 'stop' in route:
                    routes[method][route] = 'Stop SRT streaming'
                elif 'status' in route:
                    routes[method][route] = 'Get streaming status'
                elif 'urls' in route:
                    routes[method][route] = 'Get SRT streaming URI'
                elif 'validate' in route:
                    routes[method][route] = 'Validate SRT streaming environment'
                else:
