#!/usr/bin/env python3
"""
WorldBuilder HTTP Client

Handles HTTP communication with the Isaac Sim WorldBuilder Extension.
"""
...
logger = logging.getLogger("worldbuilder.client")


class WorldBuilderClient:
    """HTTP client for WorldBuilder extension communication."""

    def __init__(self, base_url: str = None):
        self.base_url = base_url or os.getenv("AGENT_WORLDBUILDER_BASE_URL", "http://localhost:8899")
...
_client: WorldBuilderClient = None


def get_client() -> WorldBuilderClient:
    """Get the global WorldBuilder client instance."""
    global _client
    if _client is None:
        _client = WorldBuilderClient()
    return _client
