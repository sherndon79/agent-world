#!/usr/bin/env python3
"""
Isaac Sim WorldStreamer MCP Server (Modular)
...
async def main():
    ...
    logger.info("🚀 Starting Isaac Sim WorldStreamer MCP Server (FastMCP - Modular)")
    ...
    logger.info(f"Registered {len(tool_names)} WorldStreamer tools")
