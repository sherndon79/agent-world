#!/usr/bin/env python3
"""
Isaac Sim WorldRecorder MCP Server (Modular)

Provides Claude Code with video recording and frame capture capabilities through MCP tools.
...
async def main():
    ...
    logger.info("🚀 Starting Isaac Sim WorldRecorder MCP Server (FastMCP - Modular)")
    ...
    logger.info(f"Registered {len(tool_names)} WorldRecorder tools")
