#!/usr/bin/env python3
"""
WorldRecorder HTTP Client

Handles HTTP communication with the Isaac Sim WorldRecorder Extension.
"""
...
logger = logging.getLogger("worldrecorder.client")


class WorldRecorderClient:
    """HTTP client for WorldRecorder extension communication."""

    def __init__(self, base_url: str = None):
        self.base_url = base_url or os.getenv("AGENT_WORLDRECORDER_BASE_URL", "http://localhost:8892")
...
_client: WorldRecorderClient = None


def get_client() -> WorldRecorderClient:
    """Get the global WorldRecorder client instance."""
    global _client
    if _client is None:
        _client = WorldRecorderClient()
    return _client
