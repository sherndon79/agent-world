#!/usr/bin/env python3
"""
Isaac Sim WorldSurveyor MCP Server (Modular)

Provides Claude Code with waypoint management and spatial navigation capabilities through MCP tools.
...
async def main():
    ...
    logger.info("🚀 Starting Isaac Sim WorldSurveyor MCP Server (FastMCP - Modular)")
    ...
    logger.info(f"Registered {len(tool_names)} WorldSurveyor tools")
